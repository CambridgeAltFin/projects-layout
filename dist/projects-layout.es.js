...
const bu = E({
...
}), dl = (e) => (Nn("data-v-20b7ac1c"), e = e(), Dn(), e), ku = ["href"], wu = /* @__PURE__ */ dl(() => /* @__PURE__ */ X("img", {
  ...
  for (const [l, a] of n)
    t[l] = a;
  return t;
}, uc = /* @__PURE__ */ vn(Pu, [["__scopeId", "data-v-20b7ac1c"]]), Eu = E({
  app: Boolean,
  color: String,
  height: {
    type: [Number, String],
...
}), Tu = (e) => (Nn("data-v-ac74e1f4"), e = e(), Dn(), e), Lu = {
...
}), cc = /* @__PURE__ */ vn(Gu, [["__scopeId", "data-v-ac74e1f4"]]), Uu = N()({
  name: "VCardActions",
  props: Y(),
  setup(e, n) {
    let {
